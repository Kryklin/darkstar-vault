...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  dArxEncrypt: (payload: string, pkHex: string, engine: string, hwid?: string) => ipcRenderer.invoke('darx-encrypt', payload, pkHex, engine, hwid),
  dArxDecrypt: (data: string, rk: string, skHex: string, engine: string, hwid?: string) => ipcRenderer.invoke('darx-decrypt', data, rk, skHex, engine, hwid),
  dArxCheckEngine: () => ipcRenderer.invoke('darx-check-engine'),
  dArxFetchEngine: () => ipcRenderer.invoke('darx-fetch-engine'),
